            ...
            <div class="col-md-12">
                ...
                <div class="jumbotron jumbotron-fluid p-2">
                    <div class="container">
                        ...
                        <p class="">Place each item in the order you prefer. Click <i class="la la-angle-down" aria-hidden="true"></i> to the right of the item to display more configuration options.</p>
                        </div>
                    </div>
                </div>
